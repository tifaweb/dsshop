...
class Dswjcmsalipay extends Basis {
	...
	public function install(){
		...
		$unite=M('unite')->where('`pid`=2')->order('`value` DESC')->find('value');
		$unite=M('unite')->add(array('pid'=>2,'name'=>'支付宝','value'=>($unite+1)));
		$arr['data']=array(		//配置参数
	...
	public function alipayreturn(){
		...
		';
		$this->DsreadFile('./Lib/Action/Home/CenterAction.class.php','/\/\/Dswjcms-tag/','','//Dswjcms-tag',$replace,$this->pluginname);
